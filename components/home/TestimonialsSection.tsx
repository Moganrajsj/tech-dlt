...
const row1Testimonials = [
    { name: "Rajesh Sharma", role: "CEO", text: "TechDLT delivered exactly what we needed. The website performance improved drastically and our client engagement has doubled within weeks." },
    { name: "Jack Morgan", role: "CTO", text: "Tech-DLT redesigned our AI infrastructure with precision. Our systems now run faster and more efficiently." },
    { name: "Priya Singh", role: "Founder", text: "The team understood our vision perfectly. Clean UI, fast loading, and very professional execution. Highly recommended!" },
    ...
    { name: "Amit Verma", role: "Manager", text: "Very smooth experience working with TechDLT. They handled everything from design to deployment without any hassle." },
    ...
    { name: "Emily Carter", role: "Marketing Head", text: "The design quality and responsiveness are top-notch. Our website now feels premium and user-friendly." },
...
const row2Testimonials = [
    ...
    { name: "David Wilson", role: "Technology Director", text: "Powerful automation tools and intelligent systems. The impact was significant." },
    { name: "Kevin Mathew ", role: "Business Owner", text: "Automation simplified our operations. We now run more efficiently." },
